...
class Topnavbar extends Component {
  ...
  render() {
    ...
    return (
      <div>
      <nav
        className={`navbar col-lg-12 col-12 p-lg-0 fixed-top d-flex  ${this.cls}`} style={this.props.name}
      >
         <a
        ...
        <div className="navbar-menu-wrapper d-flex align-items-center justify-content-between">
          ...
          <div className="navbar-nav navbar-nav-left header-links align-self-center">
            ...
            <div className="font-weight-semibold   pt-3">
              <h3 className="message-gm">
                {msg} <span className="fw-bold">John</span>
              </h3>{" "}
            </div>
          ...
          <ul className="navbar-nav navbar-nav-right mt-1">
